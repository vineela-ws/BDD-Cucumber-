 ...
 * user_already_on_login_page(){ System.setProperty(
 * "webdriver.chrome.driver","C:\\Users\\Vennela\\Desktop\\New Chrome\\chromedriver.exe"
 ...
 * 
 * @Then("^user moves to new deal page$") public void
 ...
 * user_enters_contacts_details(DataTable dealData){ List<List<String>>
 * dealValues = dealData.raw();
